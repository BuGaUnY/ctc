...
"із Ваших існуючих зовнішніх акаунтів accounts. Або, <a "
"href=\"%(signup_url)s\">Зареєструйте</a>\n"
...
"уже використане.  Будь ласка, зробіть запит на <a "
"href=\"%(passwd_reset_url)s\">нове відновлення паролю</a>."
...
"mail address</a>."
msgstr ""
"<strong>Зауважте:</strong> Ви все ще можете <a "
"href=\"%(email_url)s\">змінити Вашу e-mail адресу</a>."
...
"акаунтів.  Якщо це сталось помилково, будь ласка, <a "
"href=\"%(login_url)s\">увійдіть</a>."
